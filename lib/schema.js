    ...
    "invoice_address": {
      ...
      "definitions": {
        ...
        "identity": {
          "anyOf": [
            {
              "$ref": "#/definitions/invoice_address/definitions/heroku_id"
            }
          ]
        },
        "other": {
      ...
      "links": [
        ...
        },
        {
          ...
          "schema": {
            "properties": {
              "address_1": {
                "$ref": "#/definitions/invoice_address/definitions/address_1"
              },
              "address_2": {
                "$ref": "#/definitions/invoice_address/definitions/address_2"
              },
              "city": {
                "$ref": "#/definitions/invoice_address/definitions/city"
              },
              "country": {
                "$ref": "#/definitions/invoice_address/definitions/country"
              },
              "other": {
                "$ref": "#/definitions/invoice_address/definitions/other"
              },
              "postal_code": {
                "$ref": "#/definitions/invoice_address/definitions/postal_code"
              },
              "state": {
                "$ref": "#/definitions/invoice_address/definitions/state"
              },
              "use_invoice_address": {
                "$ref": "#/definitions/invoice_address/definitions/use_invoice_address"
              }
            },
            "type": [
              "object"
      ...
      "properties": {
        ...
        "heroku_id": {
          "$ref": "#/definitions/invoice_address/definitions/identity"
        },
        "other": {
          "$ref": "#/definitions/invoice_address/definitions/other"
        },
