    ...
    "payment": {
      ...
      "definitions": {
        ...
        "amount": {
          ...
          "example": 50000,
          "format": "$500.00 in cents - which would be 50000",
          "readOnly": false
        },
        "created_at": {
      ...
      "links": [
        {
          ...
          "schema": {
            "properties": {
              "address_1": {
                "$ref": "#/definitions/payment_method/definitions/address_1"
              },
              "address_2": {
                "$ref": "#/definitions/payment_method/definitions/address_2"
              },
              "card_number": {
                "$ref": "#/definitions/payment_method/definitions/card_number"
              },
              "city": {
                "$ref": "#/definitions/payment_method/definitions/city"
              },
              "country": {
                "$ref": "#/definitions/payment_method/definitions/country"
              },
              "cvv": {
                "$ref": "#/definitions/payment_method/definitions/cvv"
              },
              "expiration_month": {
                "$ref": "#/definitions/payment_method/definitions/expiration_month"
              },
              "expiration_year": {
                "$ref": "#/definitions/payment_method/definitions/expiration_year"
              },
              "first_name": {
                "$ref": "#/definitions/payment_method/definitions/first_name"
              },
              "last_name": {
                "$ref": "#/definitions/payment_method/definitions/last_name"
              },
              "other": {
                "$ref": "#/definitions/payment_method/definitions/other"
              },
              "postal_code": {
                "$ref": "#/definitions/payment_method/definitions/postal_code"
              },
              "state": {
                "$ref": "#/definitions/payment_method/definitions/state"
              }
            },
            "required": [
              "address_1",
